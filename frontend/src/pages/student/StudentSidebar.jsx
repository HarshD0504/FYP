      ...
      <div style={styles.navLinksContainer}>
        <ul style={styles.navLinks}>
          <li style={styles.navLink}>
            <Link to="/student/home" style={styles.link}>
              <FaHome style={styles.icon} />
              Home
            </Link>
          </li>
          <li style={styles.navLink}>
            <Link to="/student/attendance" style={styles.link}>
          ...
          {/* <li style={styles.navLink}>
            <Link to="/student/teachers" style={styles.link}>
              <FaUserTie style={styles.icon} />
              Teachers
            </Link>
          </li> */}
          <li style={styles.navLink}>
            <Link to="/student/notices" style={styles.link}>
              <FaBullhorn style={styles.icon} />
              Notices
            </Link>
          </li>
          <li style={styles.navLink}>
            <Link to="/student/contact" style={styles.link}>
